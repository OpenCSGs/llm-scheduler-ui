...
export default function themePalette(theme) {
    return {
        ...
        secondary: {
            ...
            iconBg: theme.customization.isDarkMode ? theme.colors?.darkSecondaryLight : theme.colors?.secondaryIcon,
            iconHover: theme.customization.isDarkMode ? theme.colors?.darkSecondaryLight : theme.colors?.secondaryIconHover,
            iconText: theme.customization.isDarkMode ? theme.colors?.darkSecondaryLight : theme.colors?.secondaryIconText,
