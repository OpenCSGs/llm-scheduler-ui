...
const AddQOSDialog = ({ show, row_data, onCancel, onConfirm }) => {
    ...
    useEffect(() => {
        if (show) {
            ...
            if (row_data) {
                ...
                setPreemptMode('')
                setGraceTime('')
                setPreemptExemptTime('')
                setGrpJobs('')
                setGrpTRES('')
                setGrpWall('')
                setMaxWallDurationPerJob('')
                setMaxJobsPerAccount('')
                setMaxJobsPerUser('')
                setMaxSubmitJobsPerUser('')
                setMaxSubmitJobsPerAccount('')
                setMaxTRESPerAccount(generateTresStr(''))
                setMaxTRESPerJob('')
                setMaxTRESPerNode('')
                setMaxTRESPerUser('')
                setUsageFactor('')
